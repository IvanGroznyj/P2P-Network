...
enum CommandsIndexes{CmdEcho=1, CmdHi ,CmdHash, CmdGetFile, CmdGetVirtualFile, CmdWriteToVirtualFile, CmdGetAddresses};
...
struct GetAddressesCommand: public Command{
	GetAddressesCommand();
};
